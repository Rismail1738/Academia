    ...
    <div class="container container-bg">
      <div class="row">
        <div class="col-lg-12 col-md-6 px-0">
          <form action="{{ url('add_submission') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div>
                <label>Add a Submission</label>              
            </div>
            <br>
            <div>
              <input type="text" placeholder="Submission Name" id="name" name="name" required />
              <input type="hidden" value="<?php echo Auth::user()->id; ?>" name="par">
            </div>
            <div>
                 <select id="aid" name="aid">
                                     ...
                                     <?php
                                      ...
                                      $sql = "SELECT * FROM `assignments` WHERE `status` = 'Assigned'";
                                      $all_categories = mysqli_query($con,$sql);
                                      while ($category = mysqli_fetch_array(
                                              $all_categories,MYSQLI_ASSOC)):;
                                  ?>
                                      <option value="<?php echo $category["id"];?>, <?php echo $category["teacher"];?>">
            ...
            <br>
            <div>
                <input type="file" name="pdf_path" accept=".pdf" id="pdf_path" required>
            </div>
            <div class="d-flex ">
              <button type="submit">
                SUBMIT
  ...
  <section class="client_section layout_padding">
    ...
    <div class="container px-0">
            <div class="box">
                ...
                <td style="text-align: left;
                  padding: 8px;">{{$announcements->teacher}}</td>
                <td style="text-align: left;
    ...
    <div class="container px-0">
            <div class="box">
                ...
                <td style="text-align: left;
                  padding: 8px;">{{$reports->teacher}}</td>
                <td style="text-align: left;
    ...
    <div class="container px-0">
            <div class="box">
                ...
                <td style="text-align: left;
                  padding: 8px;">{{$assignments->teacher}}</td>
                <td style="text-align: left;
    ...
    <div class="container px-0">
            <div class="box">
                ...
                <td style="text-align: left;
                  padding: 8px;"><a href="{{ url('delete_submission',$submissions->id) }}" class="btn btn-primary px-4 mx-auto mb-4" onclick="return confirm('Are You Sure You Want To Delete This Submission ?')">Delete Submission</a></td>
                </tr>
                @endforeach
                </table>
                <br>
    ...
    <div class="container px-0">
            <div class="box">
               ...
               <tr style="text-align: left;
                ...
                <td style="text-align: left;
                  padding: 8px;"><a href="{{ url('pay_invoice',$invoice->id) }}" class="btn btn-primary px-4 mx-auto mb-4" onclick="return confirm('Are You Sure You Want To Pay for This Invoice ?')">Pay Invoice</a></td>                 
                </tr>
